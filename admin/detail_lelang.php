...
<div class="col-md-7">
    <div class="card p-4 mb-4">
        ...
        <p><span class="info-label">Harga Awal:</span> Rp<?= number_format($lelang['harga_awal'],0,',','.') ?></p>
        <p><span class="info-label">Harga Akhir:</span> Rp<?= number_format($lelang['harga_akhir'],0,',','.') ?></p>
